...
namespace Cards
{
    ...
    {
        public int suitCount { get; private set; } = CardInfo.suits.Length;
        public int numberCount { get; private set; } = CardInfo.numbers.Length;
        public int cardCount { get; private set; } = CardInfo.suits.Length * CardInfo.numbers.Length;
